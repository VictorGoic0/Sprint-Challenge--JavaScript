...
const uni = graduates.map(student => student.university).filter(uni => uni.includes('Uni'));
console.log(uni);
...
*/
const populationTotal = zooAnimals.map(animal => animal.population).reduce((a, b) => {return a+b})
